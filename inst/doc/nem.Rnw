...
plot(resultPairs$graph, nodeAttrs=list(fillcolor=col))
@
...
plot(resGreedyMAP$graph, nodeAttrs=list(fillcolor=col))
@
...
plot(resultRegularization$graph, nodeAttrs=list(fillcolor=col))
@
...
plot(resultModsel$graph, nodeAttrs=list(fillcolor=col))
@
...
plot(resultBayes$graph, nodeAttrs=list(fillcolor=col))
@
...
@
}{graph100}{Inferred edge types: blue = activation, red = inhibition}
